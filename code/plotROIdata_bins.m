...
% This code plots ROIs for the UGDG task. Use for the categorical model
% ONLY.
...
rois= {'Insula_extracted' 'IFG_extracted'}; % 'pTPJ_extracted' 'seed-NAcc-thr' 'seed-vmPFC-5mm-thr'};% 'seed-pTPJ-bin' 'seed-mPFC-thr' 'seed-SPL-thr' 'seed-ACC-50-thr' 'seed-insula-thr'  'seed-dlPFC-thr'}; % 'seed-pTPJ-thr' 'seed-vmPFC-5mm-thr' 'seed-SPL-thr' 'seed-ACC-50-thr'}; % 'seed-dlPFC-UGR-bin' 'seed-ACC-10mm' 
models = {['_type-act_cov-COMPOSITE_noINT_bin_model-GLM3_']}; % ppi_seed-IFG_extracted 'nppi-ecn' nppi-ecn ppi_seed-NAcc-bin act ppi_seed-IFG_extracted};
...
if H2 == 1
    if modulated == 1
        if usenewroidir == 1
            ...
            cope_DGP_bin1={'cope-01.txt'};
            cope_DGP_bin2={'cope-02.txt'};
            cope_DGP_bin3={'cope-03.txt'};
            cope_UGP_bin1={'cope-04.txt'};
            cope_UGP_bin2={'cope-05.txt'};
            cope_UGP_bin3={'cope-06.txt'};
        ...
        type=' act';
        plot_ugdg_bin(name, roidir, rois, models, cope_DGP_bin1, cope_DGP_bin2, cope_DGP_bin3, cope_UGP_bin1, cope_UGP_bin2, cope_UGP_bin3, type, ID_Measure_1, ID_Measure_2, ID_Measure_1_name, ID_Measure_2_name)
